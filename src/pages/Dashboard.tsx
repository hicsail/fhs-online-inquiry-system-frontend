  ...
  return (
    <Box display={'flex'} flexDirection={'column'} justifyContent={'space-between'}>
      ...
      <Box display={'flex'} flexDirection={'column'} bgcolor={'white'} textAlign={'left'} sx={{minHeight: '25%', maxHeight: '50%', minWidth: '50%', maxWidth: '90%'}}>
        ...
        <br/>You can use the filters provided to narrow down the criteria of the sample and discover whether there are sample that fit your requirements and if there are, how many unique samples are available.
        </Typography>
        <Typography variant='h4' color={'black'}>
          Instructions
        </Typography> 
